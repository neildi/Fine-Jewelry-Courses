# M10 Fact-Check Table

| Claim | Type | Source | Risk | Status |
|---|---|---|---|---|
| Chanthaburi = global corundum heat-treatment hub | geography/industry | Abraham 1982; standard | low | ✅ |
| Jaipur = dominant colored-stone cutting (esp emerald); polki jewelry | industry | Lucas 2016 | low | ✅ |
| Bangkok = major trading/heat-treat/manufacturing + GIA lab | industry | standard | low | ✅ |
| Idar-Oberstein = historic agate/colored-stone cutting; Munsteiner fantasy-cut revolution | historical/industry | Anderson 1991; Munsteiner GIA piece | low | ✅ |
| Panyu/Guangzhou = major Chinese manufacturing hub | industry | Hsu/Lucas Panyu piece | low | ✅ |
| Bogotá = Colombian emerald trading/cutting capital | geography | standard; Keller 1981 | low | ✅ |
| Tucson AGTA/GJX/G&LW shows = largest annual colored-stone gathering; February | event | standard; annual G&G reports | low | ✅ |
...
| Australian basalt sapphire NSW/Queensland; black opal Lightning Ridge; Coober Pedy white opal; Queensland boulder opal | localities | standard; Wise 1993 | low | ✅ |
| Tanzanite single-source Merelani Hills Tanzania | locality | standard | low | ✅ |
| Tsavorite Kenya/Tanzania (Taita/Komolo) | locality | standard | low | ✅ |
| Utah red beryl = Ruby Violet Wah Wah Mts | locality | Shigley 2003 | low | ✅ |
...
1. Exact list of GIA origin-report species (current, not 2021 Ahline list).
2. Kashmir exhaustion date.
3. Rockefeller Emerald exact carat/auction/year.
4. Sunrise Ruby details.
