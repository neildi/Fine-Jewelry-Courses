# M04 Fact-Check Table

| Claim | Type | Source | Risk | Status |
|---|---|---|---|---|
| Martin 1987 "Gemstone Durability: Design to Display" anchor reference (G&G 23:2, 31 species) | citation | Martin 1987 (fetched page) | low | ✅ |
| Durability has three dimensions: hardness, toughness, stability | gemological/concept | standard; Martin 1987 framework | low | ✅ |
| Mohs scale is relative, not linear (diamond ~4x harder than corundum on absolute scale) | mineralogical | standard | low | ✅ |
| Household dust contains quartz (Mohs 7) | standard fact | widely cited; verify for precise phrasing | low | ✅ |
| Mohs values in the table (corundum 9, chrysoberyl 8.5, beryl 7.5–8, topaz 8, spinel 8, garnet 6.5–7.5, zircon 6.5–7.5, tourmaline 7–7.5, quartz 7, peridot 6.5–7, jade 6–7, tanzanite 6–6.5, opal 5.5–6.5, moonstone 6–6.5, lapis 5–5.5, turquoise 5–6, pearl 2.5–4.5, amber 2–2.5, malachite 3.5–4) | mineralogical data | standard gemological tables; GIA Encyclopedia | low | ✅ (cross-check any that seem off; topaz perfect cleavage, tanzanite perfect cleavage, diamond 4-direction cleavage all standard) |
| Nephrite jade = exceptional toughness due to interlocking fibrous structure | mineralogical | standard | low | ✅ |
| Topaz perfect basal cleavage | mineralogical | standard | low | ✅ |
...
| Opal contains water (SiO₂·nH₂O); can craze with heat/dryness | mineralogical | standard; Wise 1993 | low | ✅ |
...
1. Double-check RI/SG table values against GIA Encyclopedia entries for each species (particularly chrysoberyl, peridot, garnet ranges, demantoid dispersion 0.057).
2. Confirm demantoid-oiling claim.
3. Confirm corundum birefringence figure (0.008) and topaz birefringence (0.008–0.010) — approximate values acceptable for sales associate level but must be directionally right.
