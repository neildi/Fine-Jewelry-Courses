# M05 Fact-Check Table

| Claim | Type | Source | Risk | Status |
|---|---|---|---|---|
| Visible spectrum ~380–750 nm | physics | standard | low | ✅ |
| Color temperature: daylight ~5500–6500K; incandescent ~2700–3200K; cool-white fluor ~4100K | lighting | standard | low | ✅ |
| Five Fritsch-Rossman color mechanisms: (1) transition-metal ions, (2) charge transfer, (3) color centers, (4) band theory, (5) physical phenomena | framework | Fritsch-Rossman 1987/88 trilogy | low | ✅ |
| Ruby colored by Cr³⁺ | mineralogical | standard | low | ✅ |
| Emerald colored by Cr³⁺ (and sometimes V³⁺) | mineralogical | standard | low | ✅ |
| Blue sapphire blue from Fe²⁺-Ti⁴⁺ intervalence charge transfer | mineralogical | standard; Fritsch-Rossman part 2 | low | ✅ |
| Peridot colored by Fe²⁺ | mineralogical | standard | low | ✅ |
| Malachite/azurite colored by Cu | mineralogical | standard | low | ✅ |
| Rhodochrosite colored by Mn | mineralogical | standard | low | ✅ |
| Turquoise colored by Cu+Fe | mineralogical | standard | low | ✅ |
| Aquamarine blue from Fe²⁺; heat removes green | mineralogical/treatment | standard | low | ✅ |
...
| Moonstone adularescence from albite/orthoclase lamellae | mineralogical | standard | low | ✅ |
| Oregon sunstone schiller from copper platelets; Indian sunstone from hematite; aventurine quartz from fuchsite mica | mineralogical | standard | low | ✅ |
| Opal play-of-color from ordered silica spheres ~150–300 nm (diffraction/interference) | mineralogical | standard; Fritsch-Rossman part 3 | low | ✅ |
| Larger spheres (~300 nm) produce red flash; smaller produce blue | mineralogical | standard | low | ✅ |
| Crystal opal = transparent body; black opal = dark body (Lightning Ridge); boulder opal = ironstone host (Queensland); Ethiopian Welo = hydrophane | trade terms | standard | low | ✅ |
...
1. Confirm vanadium as the colorant in East African color-change garnets (Pay 2015 paper available; read full text if needed).
2. Confirm demantoid dispersion (0.057) and confirm sphene/zircon/sphalerite dispersion numbers with primary tables.
3. Confirm peridot trichroism (often described as weak; verify phrasing).
4. Nuance emerald LW fluorescence (some Colombian emeralds show red, not chalky green-yellow; clarify).
5. Clarify zultanite/diaspore naming convention.
